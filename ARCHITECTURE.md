...
- Keep feature modules cohesive. If a bug says "powerup", the first file to inspect should be `combat_system.py`; if it says "achievement", inspect `achievement_system.py`.
